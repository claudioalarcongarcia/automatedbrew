...
function botonMini(x, y, w, h, label, color, accion) {
    ...
    // Halo sutil del color del botón oscurecido
...
function textoHalo(txt, x, y, font, colorTexto, align = "left", grosorHalo = 3) {
    ...
    // Halo oscuro alrededor del texto
...
function filaGabinete(yFila, titulo, colorHeader, colorBody, botones) {
    ...
    // Header con efecto de brillo igual que los botones
...
function panelGabineteControl() {
    ...
    // Dos filas tipo filaGabinete, cada una de h=34
    ...
    filaGabinete(
        ...
        "#fff0df",
        [
            { texto: "OFF", color: "#777", accion: apagarControlTermico },
            { texto: "-", color: "#e58a32", accion: disminuirTemperatura },
            { texto: "+", color: "#e58a32", accion: aumentarTemperatura },
    ...
    filaGabinete(
        ...
        [
            { texto: "OFF", color: "#777", accion: apagarControlTermico },
            { texto: "-", color: "#1cb7ca", accion: aumentarTemperatura },
            { texto: "+", color: "#1cb7ca", accion: disminuirTemperatura },
